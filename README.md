# Macarena Hulsken | Data Analyst 📊

## Hi, I'm Macarena! 👋
Data Analyst | SQL | Python | Business Insights

I transform raw data into strategic business decisions through rigorous analysis, experimentation, and data visualization. I specialize in identifying growth opportunities and optimizing operational efficiency.

## 🛠 Tech Stack & Skills
Data Analysis: Exploratory Data Analysis (EDA), Statistical Hypothesis Testing, Cohort Analysis.
Languages & Libraries: SQL (CTEs, Window Functions, Joins), Python (Pandas, NumPy, Matplotlib, Seaborn).
Business Intelligence: KPI Development, Conversion Funnels, ROI Analysis, Retention Metrics.
Tools: Power BI, Google Sheets, Jupyter Notebooks, Git/GitHub.
